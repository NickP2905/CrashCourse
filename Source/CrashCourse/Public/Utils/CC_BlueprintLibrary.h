...
UENUM(BlueprintType)
enum class EHitDirection :uint8 { Left, Right, Forward, Back};
...
public:
	...
	static void DrawHitBoxOverlapDebugs(const UObject* WorldContextObject, TArray<FOverlapResult>& OverlapResults, const FVector& HitBoxLocation, const float HitBoxRadius);
