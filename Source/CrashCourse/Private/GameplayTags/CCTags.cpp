...
namespace CCTags
{
	...
	namespace Events
	{
		...
		namespace Player 
		{
			UE_DEFINE_GAMEPLAY_TAG_COMMENT(HitReact, "CCTags.Events.Player.HitReact", "Tag for Player HitReact Event");
		...
		namespace Enemy
		{
			...
			UE_DEFINE_GAMEPLAY_TAG_COMMENT(MeleeTraceHit, "CCTags.Events.Enemy.MeleeTraceHit", "Tag for Enemy Melee Trace hit");
